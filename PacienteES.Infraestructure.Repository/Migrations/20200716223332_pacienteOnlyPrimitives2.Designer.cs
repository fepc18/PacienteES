...
namespace PacienteES.Infraestructure.Repository.Migrations
{
    ...
    [Migration("20200716223332_pacienteOnlyPrimitives2")]
    partial class pacienteOnlyPrimitives2
    {
            ...
            modelBuilder.Entity("Domain.Entities.Paciente", b =>
                {
                    ...
                    b.Property<string>("GeneroAcompanante")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TipoIdAcompanante")
                        .HasColumnType("nvarchar(max)");
